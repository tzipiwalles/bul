            ...
            <CardContent>
              {sent ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{t('sent')}</h3>
                  <p className="text-gray-600 mb-4">{t('sentMessage')}</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="name" placeholder={t('namePlaceholder')} required className="mt-1.5" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Input id="subject" placeholder={t('subjectPlaceholder')} required className="mt-1.5" />
                  </div>
                  <div>
